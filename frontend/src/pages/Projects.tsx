  ...
  return (
    <div className="p-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2 tracking-tight">Project Portfolio</h1>
          <p className="text-slate-400">Manage and track performance across all active projects.</p>
        </div>
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-8">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full bg-sidebar border border-slate-800 rounded-xl pl-12 pr-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-accent-primary/50 transition-all"
          />
        </div>
        <button className="bg-sidebar border border-slate-800 text-slate-400 px-6 py-3 rounded-xl hover:bg-white/5 transition-all flex items-center gap-2">
      ...
      {loading ? (
        ...
        <div className="text-center py-20 bg-sidebar border border-slate-800 rounded-2xl border-dashed">
